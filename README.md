...
This project is a WebRadio player for the M5Stack Cardputer, specifically customized with Danish radio stations. It is based on the M5Cardputer_WebRadio project.
...
Firmware
The latest compiled firmware is available in this repository as M5Cardputer_WebRadio_danish.bin. You can flash this directly to your Cardputer using tools like esptool or the M5Burner.

Usage
WiFi Setup: On first boot, the device will scan for networks. Select your network and enter the password using the Cardputer keyboard. Settings are saved to EEPROM.
Controls:
/ : Next Station
, : Previous Station
; : Volume Up
...
Board Selection: Select M5Stack -> M5StampS3.
Partition Scheme: Select "No OTA(2MB APP/2MB FATFS)".
